				...
				<div class="bw d-flex flex-row align-items-center justify-content-md-around flex-wrap">
					...
					<div id="contact-form" class="bp col-md-6 left-enter">
						<form v-on:submit.prevent="sendMessage">
							...
							<!-- In case contact person is not listed. -->
							...
							<!-- Sender message. -->
							<div class="form-group">
								<label for="message" class="bs">Your message <span class="bp small">({{ messageRemainingCharacters }} characters)</span>:</label>
								<textarea v-model="contactMessage" @keyup="messageCharacterCount" class="form-control" id="message" :maxlength="messageMaxLength" rows="3" placeholder="Type in your message..." required></textarea>
							</div>
	...
	export default {
		...
		data() {
			return {
				...
				messageRemainingCharacters: 200
			}
		},
